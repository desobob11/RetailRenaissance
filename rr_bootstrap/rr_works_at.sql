...
CREATE TABLE `works_at` (
  ...
  CONSTRAINT `works_at_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `employee` (`user_id`),
  CONSTRAINT `works_at_ibfk_2` FOREIGN KEY (`branch_id`) REFERENCES `store_branch` (`branch_id`)
